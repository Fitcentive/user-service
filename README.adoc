...
== Deploy cron image
1. `docker build -t gcr.io/fitcentive-dev-02/gcloud-user-cron-pubsub-image:latest -t gcr.io/fitcentive-dev-02/gcloud-user-cron-pubsub-image:1.0 .`
2. `docker push gcr.io/fitcentive-dev-03/gcloud-user-cron-pubsub-image:1.0`