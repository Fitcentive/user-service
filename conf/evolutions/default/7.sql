...
insert into user_event_types (name, description) values ('ViewAchievements',                     'When a user views their achievements home view');
insert into user_event_types (name, description) values ('ViewDetailedStepAchievements',         'When a user views their detailed step achievements');
